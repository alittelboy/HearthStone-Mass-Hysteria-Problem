...
namespace 群体狂乱计算器
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            textBox15.Text += System.Environment.NewLine + "before simulate once:" + tmpCM + System.Environment.NewLine;
            minions.Clear();
            atkMinions.Clear();
            aliveMinions.Clear();
            for (int i = 0; i < 14; i++)
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            textBox15.Text += System.Environment.NewLine + "before times simulation：" + tmpCM + System.Environment.NewLine;
            textBox15.Text += "simulation times：" + times.ToString() + System.Environment.NewLine + "avg of ene atk frequency：" + (float)AllemAtkF / times + System.Environment.NewLine + "avg of ene atk sum：" + (float)AllemAtkS / times + System.Environment.NewLine + "avg of my atk frequency：" + (float)AllmyAtkF / times + System.Environment.NewLine + "avg of my atk sum：" + (float)AllmyAtkS / times + System.Environment.NewLine + "probability  of mine survive ：" + (float)AllmySur/ times + System.Environment.NewLine + "probability of ene survive：" + (float)AllemSur / times + System.Environment.NewLine + System.Environment.NewLine;
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            textBox15.Text += System.Environment.NewLine + "To conclude,before conclusion ：" + tmpCM + System.Environment.NewLine;
            minions.Clear();
            atkMinions.Clear();
            aliveMinions.Clear();
            for (int i = 0; i < 14; i++)
            ...
            if (bestAttck.Equals(";;;;;;;"))
            {
                bestAttck = "not move or attack face";
            }
            textBox15.Text += System.Environment.NewLine + "max point：" + maxpoint.ToString() + System.Environment.NewLine + "best solutions now：" + System.Environment.NewLine + bestAttck + System.Environment.NewLine;
            this.textBox15.Focus();//获取焦点
            this.textBox15.Select(this.textBox15.TextLength, 0);//光标定位到文本最后
            this.textBox15.ScrollToCaret();//滚动到光标处
        }
        ...
        void tryAtk(int mid,List<minion> minions2)
        {
            if (mid == 7)
            {
                ...
                {
                    bestAttck += System.Environment.NewLine + "another solution：" + System.Environment.NewLine + tmpAttack;
                }

                textBox15.Text += System.Environment.NewLine + "before simulation：" + tmpCM + "point：" + t.ToString() + System.Environment.NewLine;
            ...
            else
            {
                ...
                for (int i = 0; i <=7; i++)
                {
                    ...
                    if (i != 7 && minions2[i].hp > 0 && minions2[mid+7].hp > 0 && minions2[mid+7].canAtk==1)//如果双方存在,打一架
                    {
                        ...
                        minions2[mid+7] = ta;
                        minions2[i] = tb;
                        tmpAttack = mid.ToString() + "atk" + i.ToString() + ";"  + tmpAttack;
                    }
                    else
                    {
                        tmpAttack = ";" + tmpAttack;
        ...
        {
            System.Diagnostics.Process.Start("https://github.com/alittelboy/HearthStone-Mass-Hysteria-Problem");
        }
    }
